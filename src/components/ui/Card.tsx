...
const DancerCard = ({ dancer, isRequested, onLike, isLiked }: DancerCardProps) => {
  ...
  return (
    ...
    <div className="bg-gradient-to-br from-deep-purple to-purple-400 rounded-3xl p-4 h-full flex flex-col text-white border border-purple-400">
      ...
      <div className="flex flex-col gap-2 mt-auto">
        <button
          className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-2 rounded-lg hover:from-pink-600 hover:to-purple-700 transition-all shadow-md hover:shadow-lg"
          onClick={() => navigate(`/dancer-profile/${dancer._id}`)}
        >
          View Profile
        </button>
        {isRequested === true && (
          <button
            className="w-full bg-gradient-to-r from-purple-600 to-blue-900 text-white py-2 rounded-lg hover:from-purple-600 hover:to-blue-700 transition-all shadow-md hover:shadow-lg"
